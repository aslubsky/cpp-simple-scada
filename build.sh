...
g++ -c  "./main.cpp" -std=gnu++0x  -g -O0 -Wall  -o ./Build/main.o -I. -I. -I/usr/local/include -I/usr/include/mysql -I/usr/include -I/usr/include/modbus
...
g++ -c  "./memcached_writer.cpp" -std=gnu++0x -g -O0 -Wall  -o ./Build/memcached_writer.o -I. -I. -I/usr/local/include -I/usr/include/mysql -I/usr/include -I/usr/include/modbus
