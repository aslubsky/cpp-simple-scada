...
g++ -o ./Build/cpp_simple_scada ./Build/main.o ./Build/mysql_writer.o ./Build/serial_reader.o ./Build/mod_bus_reader.o ./Build/data_reader.o -L. -L/usr/local/lib -L/usr/lib/mysql -L/usr/lib  -lserial -lmysqlclient -lconfig -lmodbus
